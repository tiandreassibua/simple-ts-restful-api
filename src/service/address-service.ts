...
import { AddressResponse, CreateAddressRequest, GetAddressRequest, RemoveAddressRequest, UpdateAddressRequest, toAddresResponse } from "../model/address-model";
...
export class AddressService {
    ...
    static async checkAddressMustExists(contact_id: number, addressId: number): Promise<Address> {
    ...
    static async list(user: User, contactId: number): Promise<Array<AddressResponse>> {
        ...
        return addresses.map(address => toAddresResponse(address));
    }
}